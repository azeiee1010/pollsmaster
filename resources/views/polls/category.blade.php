        ...
        <div class="container">
            ...
            <div class="page-header-card fade-in">
                <div class="breadcrumb-section">
                    <nav class="breadcrumb-nav">
                        ...
                        <span class="breadcrumb-current">Category Polls</span>
                    </nav>
                </div>
                ...
                <div class="page-header">
                    ...
                    <h1 class="page-title">Category Polls</h1>
                    <p class="page-subtitle">Discover and participate in polls from your selected category</p>
                </div>
            </div>
            ...
            <div class="loading-container" id="loadingSpinner">
                <div class="loading-card">
                    ...
                    <p class="loading-text">Loading amazing polls...</p>
                </div>
            </div>
                        ...
                        const emptyStateHtml = `
                            <div class="col-12">
                                <div class="empty-state">
                                    ...
                                    <h3 class="empty-state-title">No Polls Found</h3>
                                    <p class="empty-state-text">
                                        There are currently no polls in this category.<br>
                    ...
                    const errorStateHtml = `
                        <div class="col-12">
                            <div class="error-state">
                                ...
                                <p class="error-state-text">Failed to load polls. Please try refreshing the page.</p>
